 ...
 */
@Entity
@Table(name = "Budget", catalog = "Happyhack")
public class Budget implements java.io.Serializable {

	private Integer idBudgetTable;
	...
	public Budget(Double avgPrice, Float overallRating, String url,
	...
	@Column(name = "idBudgetTable", unique = true, nullable = false)
	public Integer getIdBudgetTable() {
		return this.idBudgetTable;
	}

	public void setIdBudgetTable(Integer idBudgetTable) {
		this.idBudgetTable = idBudgetTable;
	}
