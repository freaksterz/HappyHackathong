...
/**
 * BiGramAverage generated by hbm2java
 */
@Entity
@Table(name = "BiGramAverage", catalog = "Happyhack")
public class BiGramAverage implements java.io.Serializable {
	...
	public BiGramAverage() {
	}

	public BiGramAverage(float overall, float value, float rooms,
	...
	public BiGramAverage(String content, float overall, float value,
			float rooms, float locations, float cleanliness, float chekIn,
			float service, float businessService, int sleepQuality) {
