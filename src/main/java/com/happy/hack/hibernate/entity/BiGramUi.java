...
/**
 * BiGramUi generated by hbm2java
 */
@Entity
@Table(name = "BiGramUI", catalog = "Happyhack")
public class BiGramUi implements java.io.Serializable {
	...
	public BiGramUi(String biGram, float overall, float value, float rooms,
			float locations, float cleanliness, float chekIn, float service,
			float businessService, int sleepQuality, float count) {
		this.biGram = biGram;
