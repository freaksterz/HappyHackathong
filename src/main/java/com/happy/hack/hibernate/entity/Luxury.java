...
/**
 * Luxury generated by hbm2java
 */
@Entity
@Table(name = "luxury", catalog = "Happyhack")
public class Luxury implements java.io.Serializable {

	private Integer idLuxuryTable;
	...
	public Luxury(Double avgPrice, Float overallRating, String url,
			String author, String date, String imgSrc, Integer noReader,
			Integer noHelpful, Integer overall, Integer value, Integer rooms,
			Integer locations, Integer cleanliness, Integer chekIn,
			Integer service, Integer businessService, String content,
			String stopWord, String biGram) {
	...
	@Column(name = "idLuxuryTable", unique = true, nullable = false)
	public Integer getIdLuxuryTable() {
		return this.idLuxuryTable;
	}

	public void setIdLuxuryTable(Integer idLuxuryTable) {
		this.idLuxuryTable = idLuxuryTable;
	}
