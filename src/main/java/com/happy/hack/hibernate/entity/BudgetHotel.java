...
/**
 * BudgetHotel generated by hbm2java
 */
@Entity
@Table(name = "BudgetHotel", catalog = "Happyhack")
public class BudgetHotel implements java.io.Serializable {
	...
	public BudgetHotel(float overall, float value, float rooms,
	...
	public BudgetHotel(Double avgPrice, Float overallRating, String url,
