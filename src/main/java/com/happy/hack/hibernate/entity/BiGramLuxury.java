...
/**
 * BiGramLuxury generated by hbm2java
 */
@Entity
@Table(name = "BiGramLuxury", catalog = "Happyhack")
public class BiGramLuxury implements java.io.Serializable {
	...
	public BiGramLuxury(float overall, float value, float rooms,
	...
	public BiGramLuxury(String content, float overall, float value,
