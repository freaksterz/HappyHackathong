...
/**
 * Average generated by hbm2java
 */
@Entity
@Table(name = "Average", catalog = "Happyhack")
public class Average implements java.io.Serializable {

	private Integer idAverageTable;
	...
	public Average(Double avgPrice, Float overallRating, String url,
	...
	@Column(name = "idAverageTable", unique = true, nullable = false)
	public Integer getIdAverageTable() {
		return this.idAverageTable;
	}

	public void setIdAverageTable(Integer idAverageTable) {
		this.idAverageTable = idAverageTable;
	}
