...
/**
 * BiGramUibudget generated by hbm2java
 */
@Entity
@Table(name = "BiGramUIBudget", catalog = "Happyhack")
public class BiGramUibudget implements java.io.Serializable {
	...
	public BiGramUibudget() {
	}

	public BiGramUibudget(String biGram, float overall, float value,
