...
/**
 * BiGramBudget generated by hbm2java
 */
@Entity
@Table(name = "BiGramBudget", catalog = "Happyhack")
public class BiGramBudget implements java.io.Serializable {
	...
	public BiGramBudget(float overall, float value, float rooms,
	...
	public BiGramBudget(String content, float overall, float value,
